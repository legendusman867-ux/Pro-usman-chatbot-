...
console.log(chalk.bold.hex("#03f0fc").bold("[ DEVIL YOUNGSTERS ] » ") + chalk.bold.hex("#fcba03").bold("Initializing variables..."));
...
console.log(chalk.bold.hex("#eff1f0").bold("================== THIS BOT MADE BY        DEVIL YOUNGSTERS====================="));
